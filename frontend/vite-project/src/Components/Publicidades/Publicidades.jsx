...
const Publicidades = ({text , categoria}) => {
    ...
    return (
        <div className='flex justify-center items-center p-10'>
            {
                categoria === 0 ? (
                    <div className='w-[200px] h-[100px] text-xs flex justify-center items-center bg-red-600 top-20 fixed  text-center sm:top-36 sm:w-[500px] sm:h-[200px] md:w-[600px] md:h-[250px] lg:text-2xl lg:w-[900px] lg:h-[300px] lg:top-40'>{text}</div>
