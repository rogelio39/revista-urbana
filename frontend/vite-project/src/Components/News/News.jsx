    ...
    return (
        <div className='p-10 md:p-7 flex flex-col items-center'>
            ...
            {categories.map(category => (
                <div key={category} className='mb-10 w-auto' data-category={category} width={500} height={500}>
                    <h1 className='text-center text-white mb-5 text-xl'>{category.toUpperCase()}</h1>
