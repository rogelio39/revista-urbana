        ...
        <>
            <div className='bg-slate-200 text-center rounded flex justify-center items-center '>
                <Link  aria-label={`Leer más sobre: ${data.title}`} to={`/newById/${data._id}`}>
                    <article itemScope itemType="https://schema.org/NewsArticle"  className='hover:shadow-slate-600 hover:shadow-2xl  h-[25rem] shadow-slate-500 shadow-md  flex-column overflow-hidden justify-between items-center sm:w-96' id={`Imagen del artículo:${data._id}`}>
